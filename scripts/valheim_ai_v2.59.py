...
class ValheimSimpleEnv(gym.Env):
    ...
    def _compute_reward(self, current_detections: Counter, current_health: float, 
        ...
        """All variables are now explicitly passed - no more NameError"""
    ...
    def step(self, action):
        ...
        self.last_obs = obs
        processed = self._preprocess(obs)
        current_preprocessed = processed.copy()          # ← Always defined here first
        ...
        # Compute reward - ALL variables explicitly passed
